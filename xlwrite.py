...
def output(filename, sheet,num, name, present):
    my_file = Path('C:/Users/Gaurav/Desktop/attendence/'+filename+str(datetime.now().date())+'.xls');
    if my_file.is_file():
        rb = open_workbook('C:/Users/Gaurav/Desktop/attendence/'+filename+str(datetime.now().date())+'.xls');
        book = copy(rb);
        sh = book.get_sheet(0)
        # file exists
    else:
    ...
    book.save('C:/Users/Gaurav/Desktop/attendence/'+fullname)
    return fullname;
